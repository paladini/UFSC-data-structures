...
/** Classe Fila
* Essa classe representará uma fila que herda métodos e atributos da classe Estrutura Linear. Apresentando
*métodos como: inclui, retira, filaCheia, filaVazia, getUltimo e ultimo. Sendo todos, com exceção do retira, que
*possuem comportamento associado ao de métodos da classe puoerior. Isso deve-se ao fato de que a Estrutura Linear
*é herdada por duas classes(Pilha e Fila), onde cada uma tem o seu próprio método de retirada.
*/
